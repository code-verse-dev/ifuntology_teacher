            ...
            <div className="mx-auto w-full space-y-6 pb-10">
                ...
                <Card className="rounded-[2.5rem] border-none bg-white dark:bg-slate-900 p-8 md:p-12 shadow-sm space-y-8">
                    <div className="space-y-2 text-left">
                        <h1 className="text-2xl font-extrabold text-slate-900 dark:text-white">Affiliate Partnership - FAQs</h1>
                        <p className="text-sm text-slate-500 font-medium">Everything you need to know about joining the Affiliate Program.</p>
                    </div>
