// TEMPORARILY DISABLED — country-state-city replaced with plain text fields in CountryStateCityFields.
...
export function useCountryStateCity(_options: UseCountryStateCityOptions) {
  throw new Error(
    "useCountryStateCity is temporarily disabled. Use text fields in CountryStateCityFields instead."
  );
}
